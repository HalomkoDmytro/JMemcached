...
class DefaultServer implements Server {
    ...
    protected ServerSocket createServerSocket(){
        try {
            ...
            throw new JMemcashedException("Can't create server socket with port=" + serverConfig.getServerPort(), e);
        }
    }
    ...
    public void start() {
        if(mainServerThread.getState() != Thread.State.NEW) {
            throw new JMemcashedException("Current JMemcached server already started or stopped! Please create a new server instance");
        }
